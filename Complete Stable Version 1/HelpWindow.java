...
public class HelpWindow extends Stage {
	private TextArea help = new TextArea("Summer Math Seating Program Help\n\n"
			...
			+ "\n\nOnce you have dropped your desired file in, select one of the two sessions for which you would like to sort. The program will then display sorted data in table form."
			...
			+ "\n\nWhen you are finished, click \"Save\" to save the table to an Excel file in the directory where the source file was dragged from. It will be labeled Summer Math Groups Session X, where X is the session you have selected."
			+ "\n\nQuestions? Contact the CTRL-S team: smcs2019.ctrls@gmail.com"
